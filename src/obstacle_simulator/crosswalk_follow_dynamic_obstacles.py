...
class CrosswalkFollowObstacleSimulator(ObstacleSimulator):
    def __init__(self, sampling_time: float, radius: float, birth_time: float, prediction_time_offset:int=20, speed:float=0.5) -> None:
    ...
    def _create_obstacle(self):
        ...
        x_ = np.arange(start=0, stop=16, step=speed_per_step).tolist()
