...
const NUM_STATIC_PARAMETERS: usize = 2058;
...
extern "C" {
    fn cost_function_navi_default(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double) -> c_int;
    fn grad_cost_function_navi_default(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double)
        -> c_int;
    fn mapping_f1_function_navi_default(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
    fn mapping_f2_function_navi_default(
        arg: *const *const c_double,
        casadi_results: *mut *mut c_double,
    ) -> c_int;
} // END of extern C
...
pub fn grad(u: &[f64], xi: &[f64], static_params: &[f64], cost_jacobian: &mut [f64]) -> i32 {
    ...
    unsafe {
        grad_cost_function_navi_default(
            arguments.as_ptr(),
            grad.as_mut_ptr()
        ) as i32
    }
...
pub fn mapping_f1(
    ...
    unsafe {
         mapping_f1_function_navi_default(
            arguments.as_ptr(),
...
pub fn mapping_f2(
    ...
    unsafe {
         mapping_f2_function_navi_default(
            arguments.as_ptr(),
            constraints.as_mut_ptr()
        ) as i32
    }
